-- Accept a project invite and create an assignment for the current user
-- This function allows an invited user (by email) to accept an invite and
-- creates a corresponding project_assignments row, then marks the invite accepted.
-- It runs as SECURITY DEFINER to bypass RLS while enforcing strict checks.
...
ALTER FUNCTION public.accept_project_invite(uuid) OWNER TO postgres;
